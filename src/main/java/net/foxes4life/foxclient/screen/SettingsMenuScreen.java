...
import net.foxes4life.foxclient.config.CategoryEntry;
    ...
    protected void init() {
        ...
        categories.forEach((name, category) -> {
            ...
            this.addDrawableChild(new SettingsCategorySidebarButton(0,
                    ...
                    sidebarWidth,
                    22,
                    Text.of(category.name), (button) -> {
                if(currentCategory != null) {
                    for(int i = 0; i < currentCategory.settings.size(); i++) {
                        this.remove(this.children().get(this.children().size()-1));
                    }
                }
                ...
                currentCategory.settings.forEach((key, value) -> {
                    ...
                    if (Boolean.class.equals(value.getValue().getClass())) {
                        ...
                        System.out.println("UNKNOWN: " + value.getClass());
